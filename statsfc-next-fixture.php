...
class StatsFC_NextFixture extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        // Enqueue CSS
        if ($default_css) {
            wp_register_style(STATSFC_NEXTFIXTURE_ID . '-css', plugins_url('all.css', __FILE__), null, STATSFC_NEXTFIXTURE_VERSION);
            wp_enqueue_style(STATSFC_NEXTFIXTURE_ID . '-css');
        }

        // Enqueue base JS
        wp_register_script(STATSFC_NEXTFIXTURE_ID . '-js', plugins_url('next-fixture.js', __FILE__), array('jquery'), STATSFC_NEXTFIXTURE_VERSION, true);
        wp_enqueue_script(STATSFC_NEXTFIXTURE_ID . '-js');
